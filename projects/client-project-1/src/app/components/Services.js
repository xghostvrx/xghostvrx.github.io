const Services = () => (
    <section id="services" className="p-4 md:p-8 bg-gray-100 text-center">
        ...
        <div className="mt-4 flex flex-col md:flex-row justify-around items-stretch">
            <div className="m-4 flex flex-col items-center flex-grow">
                <img src="https://placehold.co/100x100" className="w-full max-w-xs h-64 object-cover rounded mb-4 mx-auto" alt="Service 1" />
            ...
            <div className="m-4 flex flex-col items-center flex-grow">
                <img src="https://placehold.co/100x100" className="w-full max-w-xs h-64 object-cover rounded mb-4 mx-auto" alt="Service 2" />
            ...
            <div className="m-4 flex flex-col items-center flex-grow">
                <img src="https://placehold.co/100x100" className="w-full max-w-xs h-64 object-cover rounded mb-4 mx-auto" alt="Service 3" />
