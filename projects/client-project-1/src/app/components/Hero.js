...
const Hero = () => {
    return (
        <section id="landing" className="parallax h-screen font-sans text-center text-white">
            <Header />
            <div className="flex items-center justify-center min-h-screen bg-slate-600 bg-opacity-30">
                <div className="flex flex-col items-center justify-center h-full m-4 p-4">
                    ...
                    <a href="https://squareup.com/appointments/book/25cxgqy11rmt2u/LGXFNZCX8XC4X/start">
                        <button className="mt-4 px-6 py-2 text-base md:text-lg lg:text-xl bg-yellow-500 text-white rounded hover:bg-white hover:text-black transition duration-300">
                            Book a Session
                        </button>
                    </a>
                </div>
