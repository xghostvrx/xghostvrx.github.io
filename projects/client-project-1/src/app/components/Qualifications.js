const Qualifications = () => (
    <section id="qualifications" className="p-8 bg-gray-100 text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold">Meet Your Spiritual Counselor</h2>
        <div className="my-4">
            <div className="bg-white rounded-lg">
                <img src="https://placehold.co/250x250" alt="Image of Doris Bennett" className="w-64 h-64 object-cover rounded-lg mx-auto" />
            </div>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mt-4">Doris Bennett</h3>
        ...
        <div className="my-4">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold">Certifications</h3>
            <ul className="mt-4 text-lg md:text-xl lg:text-2xl">
